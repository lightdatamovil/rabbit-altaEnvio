      ...
      if (data.data.flex === 1 && data.data.mlIa == 0) {
        ...
        if (data.data.enviosDireccionesDestino) {
          const direccionDestino = new EnviosDireccionesDestino(
            ...
            data.data.enviosDireccionesDestino.delivery_preference || "R",
        ...
        if (data.data.enviosItems) {
          const enviosItems = new EnviosItems(
            insertId,
            data.data.items.codigo,
            "",
            data.data.items.descripcion,
            data.data.enviosItems.ml_id,
            data.data.items.dimensions || 0,
            data.data.items.cantidad,
            data.data.items.variacion || "",
            data.data.items.seller_sku,
            data.data.enviosItems.descargado || 0,
            data.data.enviosItems.autofecha || 0,
